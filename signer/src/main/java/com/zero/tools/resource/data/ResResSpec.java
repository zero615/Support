...
public class ResResSpec {
    ...
    public ResResource getResource(ResType config) throws ResourceException {
        return getResource(config.getFlags());
    }

    public ResResource getResource(ResConfigFlags config) throws ResourceException {
    ...
    public ResResource getDefaultResource() throws ResourceException {
    ...
    public void addResource(ResResource res, boolean overwrite) throws ResourceException {
        ...
        if (mResources.put(flags, res) != null && !overwrite) {
            throw new ResourceException(String.format("Multiple resources: spec=%s, config=%s", this, flags));
        }
    }
