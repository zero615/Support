...
public final class ResTypeSpec {
    ...
    public ResResSpec getResSpec(String name) throws ResourceException {
    ...
    public void addResSpec(ResResSpec spec) throws ResourceException {
        if (mResSpecs.put(spec.getName(), spec) != null) {
            throw new ResourceException(String.format("Multiple res specs: %s/%s", getName(), spec.getName()));
        }
    }
