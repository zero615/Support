...
import com.zero.tools.resource.xml.ResXmlEncodable;
...
public abstract class ResScalarValue extends ResIntBasedValue implements
    ...
    @Override
    public String encodeAsResXmlAttr() throws ResourceException {
        if (mRawValue != null) {
            return mRawValue;
        }
    ...
    public String encodeAsResXmlItemValue() throws ResourceException {
        return encodeAsResXmlValue();
    }

    @Override
    public String encodeAsResXmlValue() throws ResourceException {
        if (mRawValue != null) {
            return mRawValue;
        }
        return encodeAsResXml();
    ...
    public String encodeAsResXmlNonEscapedItemValue() throws ResourceException {
        return encodeAsResXmlValue().replace("&amp;", "&").replace("&lt;","<");
    }

    public boolean hasMultipleNonPositionalSubstitutions() throws ResourceException {
    ...
    protected abstract String encodeAsResXml() throws ResourceException;
}
