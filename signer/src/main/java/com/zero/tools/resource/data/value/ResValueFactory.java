...
public class ResValueFactory {
    ...
    public ResScalarValue factory(int type, int value, String rawValue) throws ResourceException {
        switch (type) {
        ...
        throw new ResourceException("Invalid value type: " + type);
    }
    ...
    public ResBagValue bagFactory(int parent, Duo<Integer, ResScalarValue>[] items, ResTypeSpec resTypeSpec) throws ResourceException {
        ...
        throw new ResourceException("unsupported res type name for bags. Found: " + resTypeName);
    }
