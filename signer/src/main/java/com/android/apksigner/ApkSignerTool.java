...
public class ApkSignerTool {
    ...
    private static void addProviders() {
        try {
            Class<?> cls = Class.forName("org.conscrypt.OpenSSLProvider");
            ...
            System.out.println("not support ssl provider ---------------"+e);
        }
    }
    ...
    private static void sign(String[] params) throws Exception {
        ...
        if (v4SigningEnabled) {
            ...
            FileUtils.deleteQuietly(outputV4SignatureFile);
        ...
        if (!tmpOutputApk.getCanonicalPath().equals(outputApk.getCanonicalPath())) {
            FileUtils.moveFile(tmpOutputApk, outputApk);
        }
