...
public abstract class V1SchemeSigner {
    ...
    public static OutputManifestFile generateManifestFile(
        ...
        for (String entryName : sortedEntryNames) {
            ...
            entryAttrs.putValue(
                    ...
                    android.util.Base64.encodeToString(entryDigest, android.util.Base64.NO_WRAP));
    ...
    private static byte[] generateSignatureFile(
        ...
        mainAttrs.putValue(
                ...
                android.util.Base64.encodeToString(md.digest(manifest.contents), android.util.Base64.NO_WRAP));
