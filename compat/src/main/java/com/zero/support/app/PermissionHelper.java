...
public class PermissionHelper {
    ...
    public static void requestPermission(InjectorViewModel viewModel, int requestCode, String... perms) {
    ...
    private static void notifyAlreadyHasPermissions(@NonNull InjectorViewModel viewModel, @NonNull String[] perms) {
