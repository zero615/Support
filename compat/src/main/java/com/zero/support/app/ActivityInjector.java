...
public class ActivityInjector {
    ...
    static {
        AppGlobal.getApplication().registerActivityLifecycleCallbacks(callbacks);
        message.observeForever(new Observer<Object>() {
            ...
            public void onChanged(Object s) {
                ...
                toast = Toast.makeText(AppGlobal.getApplication(), String.valueOf(s), Toast.LENGTH_SHORT);
                toast.show();
            }
        });
    }
    ...
    public static InjectorViewModel getTopInjectViewModel() {
    ...
    @MainThread
    public static InjectorViewModel getInjectViewModel(Activity activity) {
    ...
    @MainThread
    public static InjectorViewModel requireInjectViewModel(Activity activity) {
        InjectFragment fragment = fragments.get(activity);
        if (fragment == null) {
