package com.zero.support.compat.binding;
    ...
    public static void setViewBackground(
        ...
        if (count < 1) {
            ...
            if (count == 1 && !isDefaultNull) {
                ...
                BetterListDrawable listDrawable = new BetterListDrawable();
                if (checkedDrawable != null) {
                ...
                if (defaultDrawable != null) {
                    ...
                    if (originDrawable != null) {
                        if (originDrawable instanceof BetterListDrawable) {
                            originDrawable = ((BetterListDrawable) originDrawable).getOriginDrawable();
                        }
