...
public class SlideBar extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        textColor = a.getColor(R.styleable.ZeroSlideBar_android_textColor, Color.BLACK);
        focusTextColor = a.getColor(R.styleable.ZeroSlideBar_slideBarFocusTextColor, Color.MAGENTA);
        focusBackgroundColor = a.getColor(R.styleable.ZeroSlideBar_slideBarFocusBackgroundColor, Color.LTGRAY);
