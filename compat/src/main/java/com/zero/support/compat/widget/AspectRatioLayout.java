...
public class AspectRatioLayout extends FrameLayout {
    ...
    public AspectRatioLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        final TypedArray a = context.obtainStyledAttributes(attrs,
                R.styleable.ZeroAspectRatioLayout, defStyle, 0);
        mAspectRatio = a.getFloat(R.styleable.ZeroAspectRatioLayout_aspectRatio, 0);
        mWidthRatio = a.getFloat(R.styleable.ZeroAspectRatioLayout_layout_widthRatio, 1);
        mHeightRatio = a.getFloat(R.styleable.ZeroAspectRatioLayout_layout_heightRatio, 1);
        mMaxHeight = a.getDimensionPixelSize(R.styleable.ZeroAspectRatioLayout_aspectMaxHeight, NO_MAX_HEIGHT);
        a.recycle();
    }
