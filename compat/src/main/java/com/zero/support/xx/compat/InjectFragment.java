...
public class InjectFragment extends Fragment implements LifecycleOwner {
    ...
    public InjectViewModel getInjectViewModel() {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        injectViewModel = new InjectViewModel();
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        if (requestCode == 100) {
            if (injectViewModel != null) {
                injectViewModel.dispatchRequestPermission(permissions, grantResults);
            }
        }
    }
    ...
    public void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        if (requestCode == 100) {
            if (injectViewModel != null) {
                injectViewModel.dispatchRequestResult(resultCode, data);
            }
        }
    }
